...
const Purchase = () => {
    ...
    const handleBooking = (e) => {
        ...
        // user order 
        fetch("https://afternoon-retreat-54243.herokuapp.com/orders", {
            method: 'POST',
            headers: {
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 sm:w-8/12">
                    <div>
                        ...
                        <div className="card-body text-gray-900 p-5">
                            ...
                            <h2 className='text-xl font-medium'>Price : <span className='text-red-600'>${price}</span></h2>
                            <div className='flex g-5'>
                                <div className='text-center mr-5'>
                                    <p className='font-bold'>{minimumOrderQuantity}</p>
                                    <p className='font-medium'> <FontAwesomeIcon className='text-red-900' icon={faBattery2}></FontAwesomeIcon> Minimum Order</p>
                                </div>
                                <div className='text-center'>
                                    <p className='font-bold'>{quantity}</p>
                                    <p className='font-medium'> <FontAwesomeIcon className='text-sky-700' icon={faBatteryFull}></FontAwesomeIcon> Available Quantity</p>
                                </div>
                            </div>
