...
const Footer = () => {
    ...
    return (
        <footer className="bg-gray-700 text-white text-center sm:text-left px-10 sm:px-20">
            <div className="container py-5">
                <div className="grid sm:grid-cols-12 gap-10 py-4">
                    <div className="sm:col-start-1 sm:col-end-5 mb-4 mb-lg-0">
                        <h3 className='text-3xl font-semibold mb-4'>Bymetal Tool Inc.</h3>
                        <p className="font-italic ">Bymetal Tool Inc is the international trade association for plumbing product manufacturers, suppliers and certifier organizations. Its member companies produce most of the nation’s plumbing products.</p>
                    </div>
            ...
            <div className="py-3">
                <div className="container text-center">
                    <p className=" mb-0 py-2">Copyright © {year} | Bymetal Tool Inc. | All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
