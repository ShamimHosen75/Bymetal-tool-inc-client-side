...
const Navbar = () => {
    ...
    const menuItem = <>
        ...
        <li><Link to="/myPortofolio">My Portofolio</Link></li>
            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 text-black rounded-box w-52 font-medium">
                        {menuItem}
                        {user ? <button onClick={handleLogOut} className="btn btn-secondary text-white border-0">Sing Out</button> : <Link to="/login" className="btn btn-secondary text-white border-0">Login</Link>}
                    </ul>
                </div>
                <a className="btn btn-ghost normal-case text-2xl font-bold px-0">Bymetal Tool Inc.</a>
            </div>
